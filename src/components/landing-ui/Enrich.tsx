            ...
            <div className="relative">
                <div className="mx-auto w-5/6">
                    <div className="relative z-10 pt-7 lg:w-full lg:max-w-2xl">
                        ...
                        {/* <div className="relative px-6 py-24 sm:py-32 lg:px-8 lg:py-32 lg:pr-0 flex flex-col gap-12"> */}
                        <div className="relative px-6 pt-16 pb-24 sm:pt-20 sm:pb-32 lg:px-8 lg:pt-20 lg:pb-32 lg:pr-0 flex flex-col gap-12">
