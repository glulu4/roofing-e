...
//     {
//       name: 'TikTok',
//       href: 'https://www.tiktok.com/@paragon.exterior?lang=en', // Replace with your actual TikTok link
//       icon: (props: any) => (
//         <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
//           <path d="M12 2c1.239 0 2.402.405 3.381 1.09A7.01 7.01 0 0012 4.24c0 4.406 3.594 8 8 8 .21 0 .415-.012.619-.033A9.003 9.003 0 0113.86 22 7.971 7.971 0 0112 22c-4.406 0-8-3.594-8-8s3.594-8 8-8zM4 12c0-4.406 3.594-8 8-8v2c-3.309 0-6 2.691-6 6s2.691 6 6 6a6.98 6.98 0 004.92-2.08A9.003 9.003 0 0112 20c-4.406 0-8-3.594-8-8zm16-3.24c.355 0 .678-.122.94-.334l-3.94-3.94c-.213.262-.334.585-.334.94 0 1.238 1.005 2.24 2.24 2.24z" />
//         </svg>
//       ),
//     },
//   ],
