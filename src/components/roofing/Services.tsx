...
const services = [
    {
        ...
        description: 'Expert repairs for leaks, missing shingles, and storm damage. Fast, reliable solutions to protect your home.',
    ...
    },
    {
        ...
        description: 'Complete roof replacement with premium materials and expert installation for long-lasting protection.',
    ...
    },
    {
        ...
        href: '#',
        description: 'Tailored roofing solutions for homes, from traditional shingles to modern architectural designs.',
    ...
    },
    {
        ...
        title: 'Flat Roofing',
        href: '#',
        description: 'Specialized flat roof installation and maintenance for modern homes and commercial buildings.',
    ...
    },
    {
        ...
        href: '#',
        description: 'Professional solar panel installation to reduce energy costs and increase your home\'s value.',
                    ...
                    {services.map((service) => (
                        ...
                        >
                            ...
                            <div className="relative z-10 transform transition-all duration-300 group-hover:-translate-y-2">
                                <HeaderText variant="default" className="mt-3 text-lg/6 font-semibold text-white transition-all duration-300 group-hover:text-blue-200">
                                    <a href={service.href}>
