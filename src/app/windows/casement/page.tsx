    ...
    return (
        <div className="min-h-screen">
            ...
            <Row
                ...
                description="Proper installation ensures the window opens and closes smoothly and the window seals tightly against the outside. Our experts level each frame, adjust the hinges, and verify weatherstripping so your casement windows perform flawlessly."
