...
export const metadata: Metadata = {
    title: 'Free Roof Pitch Calculator | Calculate Roof Slope & Angle',
    description: 'Calculate your roof pitch, angle, and slope with our free professional roofing calculator. Get instant results for rise/run, degrees, and percentage.',
    keywords: [
        'roof pitch calculator',
    ...
    openGraph: {
        title: 'Free Roof Pitch Calculator - Paragon Exterior',
        description: 'Professional roof pitch calculator. Calculate roof slope, angle, and pitch notation instantly. Free tool by Paragon Exterior roofing contractors.',
        type: 'website',
        locale: 'en_US',
