...
//     const [calculationMethod, setCalculationMethod] = useState('rise-run');
//     const [results, setResults] = useState();

//     // Calculate roof pitch based on inputs
//     useEffect(() => {
//         if (calculationMethod === 'rise-run' && rise && run) {
//             const riseNum = parseFloat(rise);
//             const runNum = parseFloat(run);

//             if (riseNum > 0 && runNum > 0) {
...
//                 });
//             }
//         } else if (calculationMethod === 'angle' && angle) {
...
//     const getRoofType = (degrees) => {
//         const deg = parseFloat(degrees);
//         if (deg < 10) return {type: 'Low Slope', color: 'text-blue-600', description: 'Typically requires special membrane roofing'};
//         if (deg < 30) return {type: 'Standard Pitch', color: 'text-green-600', description: 'Most common residential roofing'};
//         if (deg < 45) return {type: 'Steep Pitch', color: 'text-orange-600', description: 'Traditional steep roofing, excellent drainage'};
//         return {type: 'Very Steep', color: 'text-red-600', description: 'Specialized installation required'};
//     };
...
//                             <span className="font-semibold">Free Tool by Paragon Exterior</span>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
//                                     <button
//                                         onClick={() => setCalculationMethod('rise-run')}
...
//                                     </button>
//                                     <button
//                                         onClick={() => setCalculationMethod('angle')}
...
//                                     </div>
//                                     <div>
//                                         <div className="font-semibold text-gray-900">Measure the Run</div>
//                                         <div className="text-sm text-gray-600">Mark a level 12-inch horizontal distance from the roof edge</div>
//                                     </div>
//                                 </div>
//                                 <div className="flex items-start">
//                                     <div className="bg-blue-100 rounded-full p-2 mr-3 mt-1">
...
//                                     </div>
//                                     <div>
//                                         <div className="font-semibold text-gray-900">Measure the Rise</div>
//                                         <div className="text-sm text-gray-600">Measure vertically from that point to the roof surface</div>
//                                     </div>
//                                 </div>
//                                 <div className="flex items-start">
//                                     <div className="bg-blue-100 rounded-full p-2 mr-3 mt-1">
...
//                                     </div>
//                                     <div>
//                                         <div className="font-semibold text-gray-900">Calculate Pitch</div>
//                                         <div className="text-sm text-gray-600">The rise over 12 inches of run gives you the pitch</div>
//                                     </div>
//                                 </div>
//                             </div>
//                         </div>
    ...
    useEffect(() => {
        ...
        const calculateFromAngle = (): void => {
            ...
            setResults({
                ...
                ratio,
                pitchNotation,
                rise: parseFloat(calculatedRise.toFixed(2)),
                run: 12
            });
        };
